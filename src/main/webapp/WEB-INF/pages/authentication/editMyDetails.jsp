            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="get-user-edit-page"><i class="fa fa-gear"></i>Manage Account</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Manage your Details here</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="username" name="username"
                                                   value="<%=request.getAttribute("username") %>" disabled="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="inputposition"
                                                   ...
                                                   value="<%=request.getAttribute("position") %>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="lastlogintime"
                                                   ...
                                                   value=<%=request.getAttribute("lastlogintime") %>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="lastlogindate"
                                                   ...
                                                   value="<%=request.getAttribute("lastlogindate") %>">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
