        ...
        <div class="col-md-11">
          <div class="box box-info">
            ...
            <div class="box-body pad ">
              <form id="process-handling-window" action="our-client-search-otherthan-com" method="post">
                <div class="col-md-5">

                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Client Ref" name="clientRef" style="width: 120px;">
                  </div>
                  <div class="form-group">
                    <table>
                      <tr>
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" name="officer2"
                           placeholder="Director/Share Holder" id="textChangeState5">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="officer3" placeholder="Secretary"
                           id="textChangeState6">
                  </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-5">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <table>
                        <tr>
                          <td ><label style="font-weight: normal;"> Statuary Accounts: </label></td>
                          <td style="width: 15px;"></td>
                          <td > <input type="checkbox" name="statuaryAccounts" class="flat-red"></td>
                        </tr>
                      </table>
                    </div>
                    <div class="form-group">
                      <table>
                        <tr>
                          <td style="width: 110px;"><label style="font-weight: normal;"> Book Keeping: </label></td>
                          <td style="width: 15px;"></td>
                          <td > <input type="checkbox" name="bookKeeping" class="flat-red"></td>
                        </tr>
                      </table>
                    </div>
                    <div class="form-group">
                      <table>
                        <tr>
                          <td style="width: 110px;"><label style="font-weight: normal;"> Payroll: </label></td>
                          <td style="width: 15px;"></td>
                          <td > <input type="checkbox"  name="payRoll" class="flat-red"></td>
                        </tr>
                      </table>
                    </div>
                    <div class="form-group">
                      <table>
                        <tr>
                          <td style="width: 110px;"><label style="font-weight: normal;"> Vat: </label></td>
                          <td style="width: 15px;"></td>
                          <td style="width: 150px;"> <select class="form-control" name="vatSelect" >
                            <option>Q-1</option>
                            <option>Q-1</option>
                            <option>Q-3</option>
                            <option>Q-4</option>
                      ...
                      <input type="hidden" value="<update this using jquery>" name="companyRegNo">
...
<script>
  ...
  $(document).ready(function () {
    ...
    $("#navigatetodatesandnotes").click(function () {
      ...
      $('#process-handling-window').attr('action', action = "dates-and-notes-otherthan-com");
