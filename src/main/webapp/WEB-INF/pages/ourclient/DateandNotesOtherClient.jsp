        ...
        <div class="col-md-10">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form action="dates-and-notes-process-com" id="dateandnotes" method="post">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <table>
                      <tr>
                        ...
                        <input type="hidden" name="comRegNo" value="${comRegNo}">
                        <td style="width: 70px;"><input type="text" class="form-control"
                                                        name="day" placeholder="Day"></td>
                        <td style="width: 15px;"></td>
                        <td style="width: 150px;"><input type="text" class="form-control"
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="dateOfIncoporate" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                  ...
                  <div class="form-group">
                    <table>
                      <tr>
                        ...
                        <td style="width: 15px;"></td>
                        <td style="width: 200px;"><input name="dateStatus" type="text" class="form-control"
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input  name="accountLastAcMadeUpTo" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="accountNextAcDue1" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="accountNextAcDue2" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="annualLastArMadeUpTo" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="annualNextArMadeUpTo" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="annualNextArDue" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="width: 200px;">
                          <div class="input-group">
                            ...
                            <input name="annualLastFullMemberList" type="text" class="form-control pull-right"
                                   id="reservationtime">
                          </div>
                          <!-- /.input group --></td>
                      </tr>
                ...
                <div class="col-md-5">
                  ...
                  <div style="padding-top:23px;">
                    <textarea value="ksjnsh" name="notesDates" class="form-control" rows="6" cols="100"
