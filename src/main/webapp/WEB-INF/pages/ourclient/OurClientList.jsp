                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <td> <span class="label label-success"  id="comRegNo" onclick="getRelaventpage(this,'<%=ourClientsNewEntityList.get(i).getComRegNo() %>')"/> <% out.print(ourClientsNewEntityList.get(i).getComRegNo()); %> </td>

                        <td><% out.print(ourClientsNewEntityList.get(i).getClientRef()); %></td>
                        <td><% out.print(ourClientsNewEntityList.get(i).getCompanyName()); %></td>
                        <td><% out.print(ourClientsNewEntityList.get(i).getType()); %></td>
                      </tr>
                      <%}%>
                      </tbody>
                      <tfoot>
...
<script>
  ...
  function getRelaventpage(cell, comid) {

    // get the form values
    var companyRegNo = comid;

    event.preventDefault();
    $.ajax({

      type: "POST",
      url: "our-client-search",
...
//        $('#value').val('');
      ...
      error: function (e) {
        alert('Error: ' + e + companyRegNo + "  " + value);
      }
    });
